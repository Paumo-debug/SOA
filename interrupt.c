...
void writeMSR(int value, int index);
...
void keyboard_routine(){
	//legim el contingut del registre 0x60 (keyboard)
	Byte value = inb(0x60);	
	if(value>>7==0){ //hem apretat el keyboard
		char c = char_map[value&0x7F];
...
void setIdt()
{
  ...
  /* ADD INITIALIZATION CODE FOR INTERRUPT VECTOR */
	...
	//ho fica al enunciat, 3.9.3 - 2 (pg 37)
